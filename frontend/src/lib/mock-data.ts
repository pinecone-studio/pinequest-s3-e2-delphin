...
export const students: Student[] = [
  // Class 10A
  {
    id: "s1",
    name: "Нандин Батхуяг",
    email: "nandinbathuyg@school.com",
    password: "nandin123",
    classId: "10A",
  },
  {
...
export const classes: Class[] = [
  {
    id: "10A",
    name: "10A анги",
    students: students.filter((s) => s.classId === "10A"),
  },
  {
    id: "10B",
    name: "10B анги",
    students: students.filter((s) => s.classId === "10B"),
  },
  {
    id: "10C",
    name: "10C анги",
    students: students.filter((s) => s.classId === "10C"),
  },
];
...
export const exams: Exam[] = [
  {
    ...
    questions: [
      ...
      },
      {
        id: "q5",
        type: "essay",
        question: "Квадрат тэгшитгэлийг бодох аргуудыг тайлбарлана уу.",
        points: 15,
      },
    ],
    duration: 45,
    ...
    questions: [
      {
        ...
        options: [
          "Нэг хүний засаглал",
          "Ард түмний оролцоотой засаглал",
          "Цэргийн засаглал",
          "Хаант засаглал",
        ],
      ...
      },
      {
        id: "q7",
        type: "true-false",
        question: "Монгол улс хаант засаглалтай.",
        correctAnswer: "Худал",
        points: 5,
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "q10",
        type: "true-false",
        question: "Хүчний нэгж нь Ньютон.",
        correctAnswer: "Үнэн",
        points: 5,
      },
    ],
...
export const examResults: ExamResult[] = [
  // 10A results for HTML Midterm
  {
    ...
    answers: [
      ...
      {
        questionId: "q5",
        answer: "Block elements take full width...",
        isCorrect: true,
      },
    ],
